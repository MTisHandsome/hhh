...
<body class="beg-login-bg" background="images/bg.jpg">
	<div class="beg-login-box">
		...
		<div class="beg-login-main">
			<form action="sys/login.action" class="layui-form" >
				...
				<div class="layui-form-item">
					<label class="beg-login-icon"> <i class="layui-icon">&#xe612;</i>
					</label> <input type="text" name="sysName" lay-verify="userName"
						autocomplete="off" placeholder="请输入登录名" class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="beg-login-icon"> <i class="layui-icon">&#xe642;</i>
					</label> <input type="password" name="sysPassword" lay-verify="password"
						autocomplete="off" placeholder="请输入密码" class="layui-input">
				</div>
				<div class="layui-form-item">
					
					<div class="beg-pull-right">
						<input type="submit" class="layui-btn layui-btn-primary" lay-submit
							lay-filter="login" value="登陆"   />
