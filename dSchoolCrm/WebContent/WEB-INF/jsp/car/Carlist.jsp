...
<body>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="role_management_add('添加用户','../car/toadd.action','900','500')">
		...
		<table class="layui-table">
			...
			<tbody>
				<c:forEach items="${list}" var="car">
					<tr>
						<td><input type="checkbox" value="${car.carId}" name="idd"
							id="id"></td>

						<td>${car.carId}</td>
						<td>${car.carCard}</td>
						<td>${car.carShape}</td>
						<td>${car.school.schoolName}</td>

						<td class="td-manage"><a title="查看" href="javascript:;"
							onclick="role_management_look('查看','../car/selUsers.action?id=${car.carId}','4','','510')" class="ml-5"
							style="text-decoration: none"> <i class="layui-icon"><img
									src="../images/look3.png" width="15" height="15"></i>
						</a><a title="编辑" href="javascript:;" onclick="role_management_edit('编辑','../car/toup.action?id=${car.carId}','700','500')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon">&#xe642;</i>
						</a><a title="删除" href="javascript:;" onclick="role_del(this,'1')"
	...
	<script>
		...
		function role_del(obj, id) {
			...
			//var delId = document.getElementByName("idd").value;
