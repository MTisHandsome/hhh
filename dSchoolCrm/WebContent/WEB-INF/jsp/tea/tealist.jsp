...
<body>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="role_management_add('添加用户','../tea/toadd.action','900','500')">
		...
		<table class="layui-table">
			<thead>
				<tr>
					<th width="8%"><input type="checkbox" name="" id="all" value="">
					</th>
					<th width="9%">ID</th>
					<th width="16%">姓名</th>
					<th width="11%">性别</th>
			...
			<tbody>
				<c:forEach items="${list}" var="tea">
					<tr>
						<td><input type="checkbox" value="${tea.teaId}" name="id"></td>
						<td>${tea.teaId}</td>
						<td>${tea.teaName}</td>
						<td>${tea.teaSex}</td>
						<td>${tea.teaPhone}</td>
						<td>${tea.teaClass==2?"科目2":""}${tea.teaClass==3?"科目3":""}</td>
						<td>${tea.teaYear}年</td>
						<td>${tea.school.schoolName}</td>
						<td class="td-manage"><a title="修改" href="javascript:;"
							onclick="role_management_permissions('分配权限','../tea/toEdit.action?id=${tea.teaId}','4','','510')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"><img src="../images/xiugai.png"
									width="15" height="15"></i>
						</a> <a title="查看" href="javascript:;"
							onclick="role_management_look('查看','../tea/query.action?id=${tea.teaId}','4','','510')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"><img src="../images/look3.png" width="15"
			  						height="15"></i>
						</a> <a title="删除" href="../tea/del.action?id=${tea.teaId}" onclick="role_del(this,'1')"
