...
<body>
	...
	<div class="x-body">
		...
		<span class="x-right" style="line-height: 25px">共有数据：88条</span></xblock>
			...
			<tbody>
				<c:forEach items="${user}" var="user">
					<tr>
						...
						<td>${user.tea.teaName}</td>
						<td>${user.car.carCard}</td>
						<td class="td-manage"><a title="修改校区"
							href="../two/toall.action?id=${user.userId}" class="ml-5"
							style="text-decoration: none"> <i class="layui-icon">&#xe642;</i>
						</a><a style="text-decoration: none"
							onclick="user_management_password('分配教练','10001','600','400')"
							href="../two/addtea.action?id=${user.userId}&&cid=${user.school.schoolId}&&tid=${user.school.schoolId}" title="分配教练及修改"> <i
								class="layui-icon">&#xe631;</i>
						</a> <a title="删除" href="../two/deleteUser.action?id=${user.userId}"
							style="text-decoration: none"> <i class="layui-icon">&#xe640;</i>
						</a></td>
					</tr>
				</c:forEach>
