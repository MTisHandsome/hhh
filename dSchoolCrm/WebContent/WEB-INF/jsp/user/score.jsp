	...
	<div class="x-body">
		...
		<button class="layui-btn layui-btn-danger">
			<i class="layui-icon"><img src="images/daoru.png" width="15"
				height="15"></img></i>导入
		</button>--> <span class="x-right" style="line-height: 25px"></span></xblock>
			...
			<tbody>
				<c:forEach items="${list}" var="user">
					<tr>
						...
						<td class="td-manage"><a title="添加" href="javascript:;"
							onclick="role_management_add('添加','../user/toAddScore.action?id=${user.userId}','750','540')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"><img src="../images/tianjia.png" width="15"
									height="15"></i>
						</a> <a title="查看" href="javascript:;"
							onclick="role_management_look('查看','../user/toScore.action?id=${user.userId}','4','','510')"
							class="ml-5" style="text-decoration: none"> <i
