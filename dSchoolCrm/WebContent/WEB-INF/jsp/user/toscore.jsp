	...
	<div class="x-body">
		<c:forEach items="${list}" var="user">
			<div class="layui-input-inline">
					...
					class="x-red"></span>学员ID
				</label> <label for="L_username" class="layui-form-label">
					${user.userId}</label> </label> <label for="L_email" class="layui-form-label">
			...
			<i class="layui-icon"><img src="images/daoru.png" width="15"
				...
				<table class="layui-table">
					...
					<tbody>
						...
						<c:forEach items="${user.scores}" var="score">
							<tr>
								<td><input type="checkbox" value="${score.scoreId}"
									name="id" id="delId"></td>
								<td>${score.scoreSchedule}</td>
								<td>${score.scoreText}</td>
								<td class="td-manage"><a title="删除" href="javascript:;"
									onclick="role_del(this,'1')" style="text-decoration: none">
